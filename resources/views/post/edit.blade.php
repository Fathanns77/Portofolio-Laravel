...
<section class="pt-16 pb-16 bg-white dark:bg-white-900 lg:flex">
    <div class="flex flex-col justify-center w-full p-8 lg:bg-white-100 lg:dark:bg-white-800 lg:px-12 xl:px-32 lg:w-1/2">
        <h1 class="text-2xl font-semibold text-gray-800 capitalize dark:text-white lg:text-3xl">Edit Post</h1>
    ...
    <div class="flex flex-col justify-center w-full p-8 pt-0 lg:w-1/2 lg:px-12 xl:px-24 ">
            ...
            <div class="-mx-2 md:items-center md:flex">
                <div class="flex-1 px-2">
                    ...
                    <input type="text" name="title" value="{{ $post->title }}" placeholder="Fathan NS" 
            ...
            <div class="w-full mt-4">
                ...
                <textarea name="body" placeholder="Isi Pesan Disini"
                    class="block w-full h-32 px-5 py-3 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-md md:h-56 dark:placeholder-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700 focus:border-blue-400 dark:focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40 ">{{ $post->body }}</textarea>
            </div>
            ...
            <a href="{{route('posts.index')}}" class=" text-white bg-blue-700 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-md text-sm px-5 py-2.5 text-center me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">GO TO POST CONTROL -></a>
        </form>
    </div>
